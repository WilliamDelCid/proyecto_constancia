		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Solicitud de acceso para el usuario: <strong><?= $datos['correo']; ?></strong></p>
					<p>Has solicitado los datos de tu usuario, accede al enlace de abajo para recuperar tu contraseña. </p>
					<p class="x_text_white">
					<a href="<?= $datos['url_recuperacion']; ?>" target="_blank" class="x_button_link x_link_blue">Confirmar datos</a>
					</p>
					<br>
					<p>Si no te funciona el botón puedes copiar y pegar la siguiente dirección en tu navegador.</p>
					<span><?= $datos['url_recuperacion']; ?></span>
