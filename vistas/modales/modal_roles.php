...
<div class="modal fade" id="modal_roles" role="dialog" aria-modal="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h5 class="modal-title" id="titulo_modal">Nuevo Rol</h5>
      ...
      <form id="formRol" name="formRol">
        ...
        <p class="text-<?= COLOR_SIDEBAR_ACTIVO ?>">Todos los campos son obligatorios.</p>
          <div class="form-group">
              ...
              <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre del rol">
          </div>
          <div class="form-group">
