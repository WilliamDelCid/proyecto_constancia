...
<div class="login-box">
  ...
  <div class="card">
    ...
    <br><br>
      ...
      <form id="form_enviar_correo_restablecer">
        <div class="input-group mb-3">
          <input type="email" class="form-control" placeholder="Correo electrónico" id="txt_email_restablecer" name="txt_email_restablecer">
