...
<div class="login-box">
  ...
  <div class="card">
    ...
    <img src="<?= url_base(); ?>/archivos/imagenes/logotaber.png" alt="" width="100%">
    <br><br>

      <form id="formRestablecerContra">
      <input type="hidden" id="id" name="id" value="<?= $datos_vista['idusuario']; ?>">
      <input type="hidden" id="token" name="token" value="<?= $datos_vista['token']; ?>">
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Nueva Contraseña" id="txt_rest_pass" name="txt_rest_pass">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Confirme Contraseña" id="txt_rest_pass2" name="txt_rest_pass2">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
