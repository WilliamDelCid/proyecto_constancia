		...
		public function obtener_permisos_rol()
		{
			...
			if($validar_token['estado'] == 1){ //el token no esta expirado
				if (isset($_SESSION['permisos_'.nombreproyecto()]['Ver Roles'])) {
					...
					if($idrol > 0)
					{
						//Obtenemos el listado de los modulos en el sistema	
						...
						if ($seleccionar_modulos['estado'] == true) {
							...
							//Recorremos ese listado de modulos
							for ($i=0; $i < count($arr_modulos); $i++) {
								...
								//Vamos armando todos los links del menu
								...
								//Vamos armando todos los contenedores para cada link, EL COLOR DEL LINK ACTIVBO ESTA EN EL ARCHIVO cargando.css
								...
								//Obtenemos el listado de los permisos en el modulo actual
								...
								if ($seleccionar_lista_permisos['estado'] == true) {
									...
									//creando contenido de cada modulo
									for ($j=0; $j < count($arr_lista_permisos); $j++) {
										...
										//Verificando si el permiso existe en la tabla relacionada
										...
										if ($existe_permiso['estado'] == true) {
											...
											if (!empty($arr_existepermiso)) {
												if ($arr_existepermiso[0]['estado_permisorol'] == 1) {
													//$lista_permisos .= '<td><button type="button" id="'.$idboton.'" class="btn btn-md" onClick="fnt_desactivar_permisorol('.$arr_existepermiso[0]->id_permisorol.',\''.$idboton.'\')" title="Desactivar permiso"><i class="fas fa-toggle-on"></i></button></td>';
													...
													//$lista_permisos .= '<td><button type="button" id="'.$idboton.'" class="btn btn-md" onClick="fnt_activar_permisorol('.$arr_existepermiso[0]->id_permisorol.',\''.$idboton.'\')" title="Activar permiso"><i class="fas fa-toggle-off"></i></button></td>';
												...
												//$lista_permisos .= '<td><button type="button" id="'.$idboton.'"class="btn btn-md" onClick="fnt_insertar_permisorol('.$idrol.','.$idpermisomodulo.',\''.$idboton.'\')" title="Activar permiso"><i class="fas fa-toggle-off"></i></button></td>';
